<?php
    ...
    //   session_start();
      if(isset($_POST['imageurl1'])){
      $url=$_POST['imageurl1'];
      $_SESSION['urlfront4'] = $url;  
      //echo $_SESSION['urlfront2'];
	  $url1=$_POST['image3'];
      $_SESSION['urlback4'] = $url1;   
	  $url2=$_POST['textinsert'];
      $_SESSION['textinsert'] = $url2; 
      $url3=$_POST['imageinsert'];
      $_SESSION['imageinsert'] = $url3;
      $url4=$_POST['designinsert'];
      $_SESSION['designinsert'] = $url4; 	  
      print_r($_SESSION);
      }
?>
<html>
...
<link rel="stylesheet" href="style.css" type="text/css">
    ...
    <style>
        ...
        background: #3C1053FF;
            ...
            .defaultstyles::-webkit-scrollbar {
            width: 5px;
            }

            /* Track */
            .defaultstyles::-webkit-scrollbar-track {
            box-shadow: inset 0 0 5px grey; 
            border-radius: 10px;
            }
            
            /* Handle */
            .defaultstyles::-webkit-scrollbar-thumb {
            background:#28a428;
            border-radius: 15px;
            z-index:5;
            }
            ...
            /* Handle on hover */
            .defaultstyles::-webkit-scrollbar-thumb:hover {
            background: #b30000; 
            }
...
<body>
<div class="site-headers"></div>
<div class="rowb">
  <div class=" menu1">
    <ul>
	  <li> <button type="button" id="text1" onclick="text()">Add Text</button></li>
      <div class="addtext" id="addtext"><div id="canceltext"><i class="fa fa-times"></i></div><textarea id="txtarea" type="textarea" name="txt"/></textarea><button id="add">Add</button></div>
      <li><button type="button" id="neckstyles" onclick="neckstyles()">Tshirt Styles</button></li>
	  <div id="cancel2"><i class="fa fa-times"></i></div>
	...
	<div class="panel">
	 <ul>
      ...
      <div><input class="jscolor {onFineChange:'changeColor(this)'}" id="colorsspop" value="DBED64">
	  <div id="cancelcolor"><i class="fa fa-times"></i></div>
	  </div>
      </ul>
	  </div>
</div>
...
<div id="canceltextedit"><i class="fa fa-times"></i></div>
...
<div class="button1">
<input id="size" type="number" class="size" value="20" min=0 onchange="changefontsize()"></div>
<div class="button1">
...
<div id="cancel-btn1"><i class="fa fa-times"></i></div>

<img id="accexpandedimg"></div>
<div class="defaultbox" id="defaultbox">
<div id="cancel1"><i class="fa fa-times"></i></div>
<img id="expandedimg">
<div class="file-name">File name here</div>
</div>
<div class="hand" id="drag">
	<div class="richtext" id="richtext" style="font-weight: normal;font-size: 20px;"></div>
	<div id="canceltxt"><i class="fa fa-times"></i></div></div>
</div> 
   </div>
...
<div id="cancel-btn1b"><i class="fa fa-times"></i></div>
<img id="accexpandedimgb"></div>
<div class="defaultboxb" id="defaultboxb">
<div id="cancel1b"><i class="fa fa-times"></i></div>
<img id="expandedimgb"/>
<div class="file-nameb">File name here</div>
<!-- <div id="cancel-btnb"><i class="fa fa-times"></i></div> -->
</div>
<div class="backhand" id="backdrag">
	<div class="backrichtext" id="backrichtext" style="font-weight: normal;font-size: 20px;" ></div>
	<div id="backcanceltxt"><i class="fa fa-times"></i></div></div>
</div> 
</div> 
    </div>
 </div>
